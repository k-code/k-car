...
#mvn install:install-file -Dfile=jogl-all-natives-linux-i586.jar -DgroupId=org.jogamp -DartifactId=jogl -Dversion=1.0 -Dpackaging=jar
#mvn install:install-file -Dfile=gluegen-rt-natives-linux-i586.jar -DgroupId=org.jogamp -DartifactId=gluegen-rt -Dversion=1.0 -Dpackaging=jar
